...
public class TeacherTodayClass extends Fragment implements RecycleViewAdapter.ItemListener {
    ...
    public TeacherTodayClass(Teacher teacher) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.teacher_today_class_frag, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        List<StudyClass> studyClasses = db.getTodayClassByTeacher(teacher.getId());
        adapter.setList(studyClasses);
        LinearLayoutManager manager = new LinearLayoutManager(getContext(), RecyclerView.VERTICAL, false);
        recyclerView.setAdapter(adapter);
        recyclerView.setLayoutManager(manager);

        System.out.println("teachertoday");
    }
